...
import com.xs.api.model.dto.user.*;
import com.xs.api.model.vo.UserAKVo;
import com.xs.api.model.vo.UserVO;
...
public class UserController {
     ...
     */
    @GetMapping("/get/aksk")
    public BaseResponse<UserAKVo> getAkAndSk(HttpServletRequest request) {
        User user = userService.getLoginUser(request);
        UserAKVo userAkVo = new UserAKVo();
        BeanUtils.copyProperties(user, userAkVo);
        return ResultUtils.success(userAkVo);
    }
    // endregion
     ...
     * @return
     */
    @PostMapping("/updateAkAndSk")
    public BaseResponse<Boolean> updateUserAkAndSk(int id, HttpServletRequest request) {
        if (id <= 0 ) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        boolean result = userService.getUpdateByAkSk(id);
        return ResultUtils.success(result);
    }
    ...
    public BaseResponse<Boolean> userResetPassword(@RequestBody UserResetPasswordRequest userResetPasswordRequest) {
        ...
        boolean result = userService.userResetPassword(userAccount, newPassword, userPassword, checkPassword);
        return ResultUtils.success(result);
    }
